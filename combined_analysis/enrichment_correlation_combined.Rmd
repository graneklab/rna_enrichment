...
ggsave(file.path(fig.dir, "all_genes_scatter.tiff"), compression = "lzw", width=20, height=25, units = "cm")
```
...
ggsave(file.path(fig.dir, "protein_coding_scatter.tiff"), compression = "lzw", width=20, height=25, units = "cm")
```
...
norm_counts_long_noreps %>%
  filter(geneid %in% ncrna_geneids) %>%
  makeEnrichmentScatterplot(fig_palette, enrich_levels)
ggsave(file.path(fig.dir, "ncrna_scatter.tiff"), compression = "lzw", width=20, height=25, units = "cm")
```
