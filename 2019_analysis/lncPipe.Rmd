...
STAR \
  ...
  --genomeDir /space/hts2018/workspace/LncPipe/genome \
  --genomeFastaFiles /space/hts2018/workspace/LncPipe/genome/Cryptococcus_neoformans_var_grubii_h99_gca_000149245.CNA3.dna.toplevel.fa \
  --sjdbGTFfile /space/hts2018/workspace/LncPipe/genome/Cryptococcus_neoformans_var_grubii_h99_gca_000149245.CNA3.46.gtf \
  --outFileNamePrefix /space/hts2018/workspace/LncPipe/genome/genome_
...
```{bash}
 ###run nextflow
 nextflow run LncPipe/LncRNAanalysisPipe.nf -with-singularity docker://nfcore/lncpipe
```
