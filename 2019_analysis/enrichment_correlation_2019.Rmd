...
list.files(starout_2019_dir, pattern = paste0(count_suffix,"$"), full.names = TRUE) ->
  countfiles
...
```{r correlation_scatter_plot_1, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
...
title_text = paste0("WT Sample #", cur_sample_num, collapse=" ")
...
#ggplot(cur_sample.tidy, aes(Total, y=value, color=variable)) + 
  ...
  #geom_point(aes(y=RNaseH, color="RNaseH"), size=1) +
  #ggtitle(title_text) +
  #labs(x="Protein-Coding Read Counts in Total Sample",y="Protein-Coding Read Counts in Enriched Sample", color='Enrichment') +
  #theme_bw() +
  #annotate("text", x=0, y = ymax, 
           #label = paste(mrna_cor, rnaseh_cor, sep="\n"),
           #hjust="inward",
...
ggplot(cur_sample.tidy) +
  geom_point(aes(Total, RNaseH), color="#f8766e", size=1, alpha=0.25) + 
  geom_smooth(aes(Total, RNaseH), method=lm, se=FALSE, color="#f8766e", size=0.25) +
  geom_point(aes(Total, mRNA), color="#00bfc4", size=1, alpha=0.25) +
  geom_smooth(aes(Total, mRNA), method=lm, se=FALSE, color="#00bfc4", size=0.25) +
  ggtitle(title_text) +
  labs(x="Protein-Coding Read Counts in Total Sample",y="Protein-Coding Read Counts in Enriched Sample") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=15000, y = 10000, 
...
# Technical Variation: Correlation Among Unenriched Replicates
# T2 vs T3 & T4 plotting
```{r}
cur_enrich_method = "Total"
cur_enrich_rep = 1

### used 'genecounts_lanes_combined_protein_coding_only %>%' previously
genecounts_lanes_combined %>%
...
### 
```{r correlation_scatter_plot_2, include=TRUE, fig.path='figures/', dev=c('png','pdf')}

makeScatterPlot = function(genecounts_lanes_combined, cur_enrich_method, cur_enrich_rep) {
...
ggplot(cur_sample.tidy, aes(Total_2, y=value, color=variable)) + 
  ...
  print(makeScatterPlot(genecounts_lanes_combined, cur_enrich_method, cur_enrich_rep = 1))
```
```{r correlation_scatter_plot_3, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
...
ggplot(cur_sample.tidy) +
  geom_point(aes(Total_2, Total_3), color="black", size=2, alpha=0.2) + 
  geom_smooth(aes(Total_2, Total_3), method=lm, se=FALSE, color="black", size=0.25) +
  ggtitle("WT 2019") +
  labs(x="Read Counts in Total Sample #2",y="Read Counts in Total Sample #3") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=5000000, y = 0, 
           label = paste(T3_cor),
           hjust="inward",
           vjust="inward", 
           color="black")
  ...
  print(makeScatterPlot(genecounts_lanes_combined, cur_enrich_method, cur_enrich_rep = 1))
```
```{r correlation_scatter_plot_4, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
...
#------------------------------------------------------------------
ggplot(cur_sample.tidy) +
  geom_point(aes(Total_2, Total_4), color="black", size=2, alpha=0.2) + 
  geom_smooth(aes(Total_2, Total_4), method=lm, se=FALSE, color="black", size=0.25) +
  ggtitle("WT 2019") +
  labs(x="Read Counts in Total Sample #2",y="Read Counts in Total Sample #4") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=5000000, y = 0, 
...
```
# T3 vs T4 plotting
```{r correlation_scatter_plot_5, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
...
#------------------------------------------------------------------
ggplot(cur_sample.tidy) +
  geom_point(aes(Total_3, Total_4), color="black", size=2, alpha=0.2) + 
  geom_smooth(aes(Total_3, Total_4), method=lm, se=FALSE, color="black", size=0.25) +
  ggtitle("WT 2019") +
  labs(x="Read Counts in Total Sample #3",y="Read Counts in Total Sample #4") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=5000000, y = 0, 
...
```{r tRNA_correlation_plots, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
...
#------------------------------------------------------------------
ggplot(cur_sample.tidy, aes(Total, y=value, color=variable)) + 
  geom_point(aes(y=RNaseH, color="RNaseH"), size=3) + 
  geom_point(aes(y=mRNA, color="mRNA"), size=3) +
  ggtitle(title_text) +
  labs(x="Read Counts in Total Sample",y="Read Counts in Enriched Sample", color='Enrichment') +
  theme_bw() +
  annotate("text", x=1, y = ymax, 
           label = paste(rnaseh_cor, mrna_cor, sep="\n"),
           hjust="inward",
           vjust="inward", 
           color="black")
...
ggplot(cur_sample.tidy) +
  ...
  geom_smooth(aes(Total, mRNA), method=lm, se=FALSE, color="#00bfc4", size=0.25) +
  ggtitle(title_text) +
  labs(x="ncRNA Read Counts in Total Sample",y="ncRNA Read Counts in Enriched Sample") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=4000, y = 10000, 
           label = paste(rnaseh_cor, mrna_cor, sep="\n"),
           hjust="inward",
           vjust="inward", 
           color="black")
...
list.files(starout_2018_dir, pattern = paste0(count_suffix,"$"), full.names = TRUE) %>%
      path_filter(regex="_") ->
  countfiles2018
...
accessions_file %>%
  read_csv %>%
  select(Run, Label=sample_id) %>%
  right_join(genecountsRZ,by=c("Run"="expid")) %>%
  select(-Run)->
  genecountsRZ_with_label

genecountsRZ_with_label[1:6,1:6] %>%
  kable
```
...
genecountsRZ_lanes_combined[1:6,1:6] %>%
  kable
```
## Compare library preps
...
```
# testing for protein-coding correlations
```{r}
h99_grangesRZ %>% 
  as.data.frame %>% 
  filter(gene_biotype != "protein_coding") %>%
  pull(gene_id) %>%
  unique ->
  all_non_protein_coding_gene_IDs_RZ
```

```{r}
all_non_protein_coding_and_rrna_homologs_gene_IDs_RZ = 
  union(all_non_protein_coding_gene_IDs_RZ, strand_specific_rrna_homologs)

genecountsRZ_lanes_combined %>%
  dplyr::select(all_non_protein_coding_and_rrna_homologs_gene_IDs_RZ) ->
  check_selectRZ
...
genecountsRZ_lanes_combined %>%
  dplyr::select(-all_non_protein_coding_and_rrna_homologs_gene_IDs_RZ) ->
  genecounts_lanes_combined_protein_coding_only_RZ

genecounts_lanes_combined_protein_coding_only_RZ[,1:6] %>%
  kable


dim(check_selectRZ)
dim(genecountsRZ_lanes_combined)
dim(genecounts_lanes_combined_protein_coding_only_RZ)

# dplyr::select(genecountsRZ_lanes_combined,small_MTrRNA)
```
# plotting for RZ protein-coding correlations - 2018 RZ to 2018 TOT
```{r RZ2018_protein_coding_correlation_scatter_plot, include=TRUE, fig.path='figures/', dev=c('png','pdf')}

makeScatterPlot = function(genecounts_lanes_combined_protein_coding_only_RZ, cur_sample_num, cur_enrich_rep = 1) {
...
ggplot(cur_sample.tidy) +
  geom_point(aes(TOT, RNaseH), color="#f8766e", size=1, alpha=0.25) + 
  geom_smooth(aes(TOT, RNaseH), method=lm, se=FALSE, color="#f8766e", size=0.25) +
  geom_point(aes(TOT, RZ), color="#6fc18a", size=1, alpha=0.25) +
  geom_smooth(aes(TOT, RZ), method=lm, se=FALSE, color="#6fc18a", size=0.25) +
  ggtitle(title_text) +
  labs(x="Protein-Coding Read Counts in Total Sample (2018)",y="Protein-Coding Read Counts in Enriched Sample") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=4000, y = 0, 
...
for (cur_sample in 2:4) {
  print(makeScatterPlot(genecounts_lanes_combined_protein_coding_only_RZ, cur_sample, cur_enrich_rep = 1))
}
```
# plotting for RZ protein-coding correlations - 2018 RZ to 2019 Total
```{r RZ2019_protein_coding_correlation_scatter_plot, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
...
ggplot(cur_sample.tidy) +
  geom_point(aes(Total, RNaseH), color="#f8766e", size=1, alpha=0.25) + 
  geom_smooth(aes(Total, RNaseH), method=lm, se=FALSE, color="#f8766e", size=0.25) +
  geom_point(aes(Total, RZ), color="#6fc18a", size=1, alpha=0.25) +
  geom_smooth(aes(Total, RZ), method=lm, se=FALSE, color="#6fc18a", size=0.25) +
  ggtitle(title_text) +
  labs(x="Protein-Coding Read Counts in Total Sample (2019)",y="Protein-Coding Read Counts in Enriched Sample") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=4000, y = 0, 
...
ggplot(cur_sample.tidy) +
  ...
  geom_smooth(aes(TOT, RZ), method=lm, se=FALSE, color="#6fc18a", size=0.25) +
  ggtitle(title_text) +
  labs(x="ncRNA Read Counts in Total Sample (2018)",y="ncRNA Read Counts in Enriched Sample") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=4000, y = 0, 
...
#------------------------------------------------------------------
#ggplot(cur_sample.tidy, aes(Total, y=value, color=variable)) + 
  #geom_point(aes(y=RNaseH, color="RNase H"), size=1) +
  #geom_point(aes(y=RZ, color="Ribo-Zero"), size=1) +
  #geom_smooth(aes(RNaseH), method=lm, se=FALSE, color="black") +
  #geom_smooth(aes(RZ), method=lm, se=FALSE, color="black") +
  #ggtitle(title_text) +
  #labs(x="Read Counts in Total Sample",y="Read Counts in Enriched Sample", color='Enrichment') +
  #theme_bw() +
  #annotate("text", x=0, y = ymax, 
...
ggplot(cur_sample.tidy) +
  ...
  geom_smooth(aes(Total, RZ), method=lm, se=FALSE, color="#6fc18a", size=0.25) +
  ggtitle(title_text) +
  labs(x="ncRNA Read Counts in Total Sample (2019)",y="ncRNA Read Counts in Enriched Sample") +
  theme_classic() +
  annotate("text", x=4000, y = 0, 
           label = paste(rnaseh_cor, RZ_cor, sep="\n"),
           hjust="inward",
...
```{r 2018_2019_total_scatter_plot_1, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
# head (h99_granges)
...
genecountsRZ_lanes_combined_protein_coding_only[1:6,1:6] %>%
  kable
```
# Plotting Total 2 comparison
```{r 2018_2019_total_scatter_plot_2, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
cur_sample_num = "2"
cur_enrich_rep = 1
...
ggplot(cur_sample_total2.tidy) +
  geom_point(aes(Total_2_2019, Total_2_2018), color="black", size=2, alpha=0.2) + 
  geom_smooth(aes(Total_2_2019, Total_2_2018), method=lm, se=FALSE, color="black", size=0.25) +
  ggtitle(title_text) +
  labs(x="Read Counts in Total Sample (2019)",y="Read Counts in Total Sample (2018)") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
  theme(axis.text.y = element_text(colour = "black")) +
  annotate("text", x=5000000, y = 0, 
...
```{r 2018_2019_total_scatter_plot_3, include=TRUE, fig.path='figures/', dev=c('png','pdf')}
cur_sample_num = "3"
cur_enrich_rep = 1
...
ggplot(cur_sample_total3.tidy) +
  geom_point(aes(Total_3_2019, Total_3_2018), color="black", size=2, alpha=0.2) + 
  geom_smooth(aes(Total_3_2019, Total_3_2018), method=lm, se=FALSE, color="black", size=0.25) +
  ggtitle(title_text) +
  labs(x="Read Counts in Total Sample (2019)",y="Read Counts in Total Sample (2018)") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
...
ggplot(cur_sample_total4.tidy) +
  geom_point(aes(Total_4_2019, Total_4_2018), color="black", size=2, alpha=0.2) + 
  geom_smooth(aes(Total_4_2019, Total_4_2018), method=lm, se=FALSE, color="black", size=0.25) +
  ggtitle(title_text) +
  labs(x="Read Counts in Total Sample (2019)",y="Read Counts in Total Sample (2018)") +
  theme_classic() +
  theme(axis.text.x = element_text(colour = "black")) +
