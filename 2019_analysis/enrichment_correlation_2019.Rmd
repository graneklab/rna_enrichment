...
ggplot(cur_sample.tidy, alpha = 1/2) +
  geom_point(aes(Total, RNaseH), color="#f8766e", size=1) + 
  geom_smooth(aes(Total, RNaseH), method=lm, se=FALSE, color="#f8766e") +
  geom_point(aes(Total, mRNA), color="#00bfc4", size=1) +
  geom_smooth(aes(Total, mRNA), method=lm, se=FALSE, color="#00bfc4") +
  ggtitle(title_text) +
...
ggplot(cur_sample.tidy, alpha = 1/2) +
  geom_point(aes(TOT, RNaseH), color="#f8766e", size=1) + 
  geom_smooth(aes(TOT, RNaseH), method=lm, se=FALSE, color="#f8766e") +
  geom_point(aes(TOT, RZ), color="#6fc18a", size=1) +
  geom_smooth(aes(TOT, RZ), method=lm, se=FALSE, color="#6fc18a") +
  ggtitle(title_text) +
...
ggplot(cur_sample.tidy, alpha = 1/2) +
  geom_point(aes(Total, RNaseH), color="#f8766e", size=1) + 
  geom_smooth(aes(Total, RNaseH), method=lm, se=FALSE, color="#f8766e") +
  geom_point(aes(Total, RZ), color="#6fc18a", size=1) +
  geom_smooth(aes(Total, RZ), method=lm, se=FALSE, color="#6fc18a") +
  ggtitle(title_text) +
...
ggplot(cur_sample_total2.tidy, alpha = 1/2) +
  geom_point(aes(Total_2_2019, Total_2_2018), color="grey", size=2) + 
  geom_smooth(aes(Total_2_2019, Total_2_2018), method=lm, se=FALSE, color="black") +
  ggtitle(title_text) +
  theme_bw() +
...
ggplot(cur_sample_total3.tidy, alpha = 1/2) +
  geom_point(aes(Total_3_2019, Total_3_2018), color="grey", size=2) + 
  geom_smooth(aes(Total_3_2019, Total_3_2018), method=lm, se=FALSE, color="black") +
  ggtitle(title_text) +
  theme_bw() +
  annotate("text", x=5000000, y = 0, 
           label = paste(T3_cor),
...
ggplot(cur_sample_total4.tidy, alpha = 1/2) +
  geom_point(aes(Total_4_2019, Total_4_2018), color="grey", size=2) + 
  geom_smooth(aes(Total_4_2019, Total_4_2018), method=lm, se=FALSE, color="black") +
  ggtitle(title_text) +
  theme_bw() +
  annotate("text", x=5000000, y = 0, 
           label = paste(T4_cor),
