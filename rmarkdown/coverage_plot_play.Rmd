...
## 21s rRNA annotation
```{r}
gene_21s = GRanges(seqnames = full_mito_name, 
...
## 15s rRNA annotation
```{r}
gene_15s = GRanges(seqnames = full_mito_name, 
...
names(seq_15s) = "15s_rRNA__CNA3"
seq_21s = getSeq(h99_genome, gene_21s)
names(seq_21s) = "21s_rRNA__CNA3"

writeXStringSet(seq_15s, file.path(seq_dir, "15s_rRNA__CNA3.fasta"), format="fasta")
writeXStringSet(seq_21s, file.path(seq_dir, "21s_rRNA__CNA3.fasta"), format="fasta")
```

https://www.ncbi.nlm.nih.gov/nucleotide/AY101381.1?report=genbank&log$=nucltop&blast_rank=3&RID=8Y4N4142014
...
export(GRangesList(gene_15s, gene_21s), 
       con = file.path(seq_dir, "mito_rrna.gtf"),
       format="gff2")
```
