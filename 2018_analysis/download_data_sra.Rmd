...
# Get Accesion-to-Sample Mapping from SRA
```{r}
entrez_search(db="sra", term="PRJNA673133") ->
  sra_search
...
sra_df
```
# Get Accesion-to-Sample Mapping from GEO
```{r}
...
left_join(sra_df, 
  ...
  dplyr::select(Run, Experiment, SampleName, title, `enrichment method:ch1`, `genotype:ch1`, `media:ch1`, `rna sample number:ch1`,`strain:ch1`) %>%
