...
rm -rf $OUTDIR
mkdir -p $OUTDIR
time sh -c "fasterq-dump --outdir $OUTDIR SRR12933702 --force ; gzip $OUTDIR/SRR12933702.fastq"
```
...
rm -rf $OUTDIR
mkdir -p $OUTDIR
time sh -c "fasterq-dump SRR12933702 --force --stdout; gzip $OUTDIR/SRR12933702.fastq"
```
